...
from iti.Model import GeneratorAB, GeneratorBA, Discriminator, NoiseEstimator, DiscriminatorMode
...
class Trainer(nn.Module):
    ...
    def startBasicTraining(self, base_dir, ds_A, ds_B, ds_valid_A=None, ds_valid_B=None,
                           ...
                           iterations=220000, num_workers=8, validation_history=False, batch_size=1):
        self.cuda()
        start_it = self.resume(base_dir)
        # Init Callbacks
        from Callback import HistoryCallback, ProgressCallback, SaveCallback, PlotBAB, PlotABA, ValidationHistoryCallback
