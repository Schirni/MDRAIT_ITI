...
class SOLODownloader:
    ...
    def __init__(self, base_path):
        ...
        self.dirs = ['eui-hrieuv174-image', 'eui-fsi174-image', 'eui-fsi304-image']
...
if __name__ == '__main__':
    ...
    start_date = datetime(2023, 10, 26, 9, 0)
    end_date = datetime.now()
    #end_date = datetime(2020, 5, 30, 14, 59)
    ...
    for d in [start_date + i * timedelta(minutes=1) for i in
              range((end_date - start_date) // timedelta(minutes=1))]:
